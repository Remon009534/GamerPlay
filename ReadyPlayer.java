...
public class ReadyPlayer {
    ...
    public ReadyPlayer(String FullName, String UserName, int gamerPoints, String playerTier, String subscriptionType, int readyCoins)
    {
        this.id += 1;
    ...
    public String PlayerTier(int gamerPoints)
    {
    ...
    public void showInfo()
    {
        ...
        System.out.println("PlayerTier:- " + playerTier);
